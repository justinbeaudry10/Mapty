...
// 1. User Stories (Description of the app's functionality from the user's persepective. All user stories put together describe the entire application)
// 2. Features
...
// As a user, I want to log my cycling workouts with location, distance, time, speed and elevation gain, so I can keep a log of all my running
